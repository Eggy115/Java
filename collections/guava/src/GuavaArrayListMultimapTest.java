...
//
public class GuavaArrayListMultimapTest {
    ...
    public static void main(String[] args) {
        ...
        // Print all words
        System.out.println(multiMap); // print {Hi=[4], Hello=[0, 2], World!=[1, 5], All!=[3]} - keys in random orders, values in predictable iteration order
        // Print all unique words
        System.out.println(multiMap.keySet());    // print [Hello, World!, All!, Hi]- in random orders
